...
export default function HospitalLogin() {
    ...
    const checkUsername = async () => {
      ...
      try {
        ...
        const res = await axios.get(
          `${BASE_URL}/checkhospitalusername/${encodeURIComponent(
            debouncedUsername
          )}`
        );
  ...
  const handleRegister = () => {
    ...
    sessionStorage.setItem("prefill_hospital_username", username);
              ...
              <Box display="flex" flexDirection="column">
                ...
                {checkingUsername && (
                  <Box display="flex" justifyContent="center" sx={{ mb: 2 }}>
                    <CircularProgress size={24} sx={{ color: BLUE_ACCENT }} />
                  </Box>
                )}
                      ...
                      <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}>
                        <Button
                          ...
                          sx={{
                            ...
                            borderColor: BLUE_ACCENT,
                            background:
                              "linear-gradient(90deg, rgba(46,134,222,0.06) 0%, rgba(27,182,236,0.12) 100%)",
                            "&:hover": {
                              borderColor: BLUE_ACCENT,
                              background:
                                "linear-gradient(90deg, rgba(46,134,222,0.12) 0%, rgba(27,182,236,0.18) 100%)",
                            },
                          }}
                        >
                          Register Here
